    ...
    def __init__(self, list=None):
        ...
        if list == None:
            ...
            for i in range(0, size):
                while 1:
                    rand_row = random.randint(0, int(n)-1)
                    rand_col = random.randint(0, int(n)-1)
...
class queens:
    ...
    def printstats(self):
        ...
        print("Total Success: ", tempCount )
        #print("Temp Count: ", tempCount)
        print("Success Percentage: ", float(tempCount) / float(self.totalruns))
        ...
        for i in range(0, int(n)):
            for j in range(0, int(n)):
                ...
                if tboard.board[i][j] == "Q":
                    ...
                    k, l = i + 1, j + 1
                    while k < int(n) and l < int(n):
                        if tboard.board[k][l] == "Q":
                            totaldcost += 1
                        k += 1
                        l += 1
                    k, l = i + 1, j - 1
                    while k < int(n) and l >= 0:
                        if tboard.board[k][l] == "Q":
                            totaldcost += 1
                        k += 1
                        l -= 1
                    k, l = i - 1, j + 1
                    while k >= 0 and l < int(n):
                        if tboard.board[k][l] == "Q":
                            totaldcost += 1
                        k -= 1
                        l += 1
    ...
    def getlowercostboard(self):
        ...
        for q_row in range(0, int(n)):
            for q_col in range(0, int(n)):
                if self.mboard.board[q_row][q_col] == "Q":
                    # get the lowest cost by moving this queen
                    for m_row in range(0, int(n)):
                        for m_col in range(0, int(n)):
